...
<body class="home-page home-01 ">
					...
					<div class="header-nav-section">
						<div class="container">
							<ul class="nav menu-nav clone-main-menu" id="mercado_haead_menu" data-menuname="Sale Info" >
								...
								<li class="menu-item"><a href="#" class="link-term">Top Products</a><span class="nav-label hot-label">hot</span></li>
							</ul>
						</div>
					</div>
	...
	<script src="https://cdn.tiny.cloud/1/ab37ymooykm17c1o9mv9oxihdd55ard3vx2vfr41kvijvwh6/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
    @livewireScripts
	@stack('scripts')
</body>
</html>