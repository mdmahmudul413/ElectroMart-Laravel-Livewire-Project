                    ...
                    <div class="panel-body">
                        <form action="" class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent="addProduct">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="file" class="form-control input-file" id="productimage" wire:model="image">
                                    @error('image')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                @if ($image)
                                    <div class="col-md-8 pull-right">
                                        <img style="border: 2px solid black; margin-top: 15px;" src="{{ $image->temporaryUrl() }}" width="240">
                                    </div>
                                @endif

                            </div>
                            <div class="form-group">
                                <label for="productgallery" class="col-md-4 control-label">
                                    Produt Gallery
                                </label>
                                <div class="col-md-4">
                                    <input type="file" class="form-control input-file" id="productgallery" wire:model="images" multiple>
                                    @if ($images)
                                        @foreach ($images as $image)
                                            <img src="{{ $image->temporaryUrl() }}" width="110">
                                        @endforeach
                                    @endif
                                </div>
