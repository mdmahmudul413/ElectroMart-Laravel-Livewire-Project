                                                ...
                                                <li class="comment byuser comment-author-admin bypostauthor even thread-even depth-1" id="li-comment-20">
                                                    <div id="comment-20" class="comment_container"> 
                                                        @if ($orderItem->order->user->profile->image)
                                                            <img alt="{{ $orderItem->order->user->profile->image }}" src="{{asset('assets/images/profile')}}/{{ $orderItem->order->user->profile->image }}" height="80" width="80">
                                                        @else
                                                            <img alt="" src="{{ asset('assets/images/profile/User-Profile-PNG.png') }}" height="80" width="80">
