                        ...
                        <div class="product product-style-3 equal-elem ">
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-wish">
                                    ...
                                    <a wire:click.prevent="removeFromWishlist({{ $product->id }})" title="Remove this product to Wishlist" href="#"><i class="fa fa-heart fill-heart"></i></a>
                                    @else 
                                    <a wire:click.prevent="addToWishlist({{ $product->id }}, '{{ $product->name }}', {{ $product->regular_price }})" title="Add this product to Wishlist" href="#"><i class="fa fa-heart"></i></a>
                                    @endif
                                </div>
                            </div>
                        </div>
